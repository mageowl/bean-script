...
scope.localFunctions.set("abs", {
    ...
    run(number) {
        if (number.type !== "NumberLiteral") {
            error(`I need a number to get the absolute value. I got a ${number.type}.`, "Type");
        }
...
scope.localFunctions.set("cos", {
    ...
    run(number) {
        if (number.type !== "NumberLiteral") {
            error(`I need a number to get the cosine. I got a ${number.type}.`, "Type");
        }
...
scope.localFunctions.set("tan", {
    ...
    run(number) {
        if (number.type !== "NumberLiteral") {
            error(`I need a number to get the tangent. I got a ${number.type}.`, "Type");
        }
...
scope.localFunctions.set("atan", {
    ...
    run(number) {
        if (number.type !== "NumberLiteral") {
            error(`I need a number to get the arc tangent. I got a ${number.type}.`, "Type");
        }
...
scope.localFunctions.set("sqrt", {
    ...
    run(number) {
        if (number.type !== "NumberLiteral") {
            error(`I need a number to get the square root. I got a ${number.type}.`, "Type");
        }
